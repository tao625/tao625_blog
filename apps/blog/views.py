...
class IndexView(generic.ListView):
    ...
    def get_queryset(self):
        ...
        return queryset.filter(is_secret=False).select_related('author', 'category').prefetch_related('tags')
...
class CategoryView(generic.ListView):
    ...
    def get_queryset(self, **kwargs):
        ...
        return queryset.filter(category=cate, is_secret=False).select_related('author', 'category').prefetch_related('tags')
...
class TagView(generic.ListView):
    ...
    def get_queryset(self, **kwargs):
        ...
        return queryset.filter(Q(tags=tag) & Q(is_secret=False)).select_related('author', 'category').prefetch_related('tags')
