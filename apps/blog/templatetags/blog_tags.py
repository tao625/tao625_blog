...
def keywords_to_str(art):
    """将文章关键词变成字符串"""
    return ','.join([key.name for key in art.keywords.all()])
...
def get_star_title(num):
    """得到星星个数的说明"""
    the_dict = {
        1: '【1 颗星】：微更新，涉及轻微调整或者后期规划了内容',
        2: '【2 颗星】：小更新，小幅度调整，一般不会迁移表格',
        3: '【3 颗星】：中等更新，一般会增加或减少模块，有表格的迁移',
        4: '【4 颗星】：大更新，涉及到应用的增减',
        5: '【5 颗星】：最大程度更新，一般涉及多个应用和表格的变动',
    }
    return the_dict[num]
